      ...
      child: Column(
        ...
        children: [
          ...
          Row(children: [
            ...
            Text(userViewModel.userDetail!.followers.toString(), style: const TextStyle(fontWeight: FontWeight.bold),),
            const Text(" Followers - "),
            Text(userViewModel.userDetail!.following.toString(), style: const TextStyle(fontWeight: FontWeight.bold),),
          ...
          ElevatedButton(
              ...
              onPressed:  () => Navigator.of(context).push(MaterialPageRoute(
                  builder: (context)=>const UserRepositorys(userLoginId: "dionlaranjeira"))),
              child: Row(
                children: [
